...
declare class G8Tesseract extends NSObject {
	...
	constructor(o: { language: string; configDictionary: NSDictionary<any, any>; configFileNames: NSArray<any>; absoluteDataPath: string; engineMode: G8OCREngineMode; copyFilesFromResources: boolean; });
	...
	initWithLanguageConfigDictionaryConfigFileNamesAbsoluteDataPathEngineModeCopyFilesFromResources(language: string, configDictionary: NSDictionary<any, any>, configFileNames: NSArray<any>, absoluteDataPath: string, engineMode: G8OCREngineMode, copyFilesFromResources: boolean): this;
