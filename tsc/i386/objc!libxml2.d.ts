...
interface _xmlDOMWrapCtxt {
	...
	getNsForNodeFunc: interop.FunctionReference<(p1: interop.Pointer | interop.Reference<_xmlDOMWrapCtxt>, p2: number, p3: interop.Pointer | interop.Reference<number>, p4: interop.Pointer | interop.Reference<number>) => interop.Pointer | interop.Reference<_xmlNs>>;
}
...
declare function xmlCheckHTTPInput(ctxt: number, ret: interop.Pointer | interop.Reference<_xmlParserInput>): number;
...
declare function xmlGcMemGet(freeFunc: interop.Pointer | interop.Reference<number>, mallocFunc: interop.Pointer | interop.Reference<number>, mallocAtomicFunc: interop.Pointer | interop.Reference<number>, reallocFunc: interop.Pointer | interop.Reference<number>, strdupFunc: interop.Pointer | interop.Reference<number>): number;

declare function xmlGcMemSetup(freeFunc: number, mallocFunc: number, mallocAtomicFunc: number, reallocFunc: number, strdupFunc: number): number;
...
declare function xmlMemGet(freeFunc: interop.Pointer | interop.Reference<number>, mallocFunc: interop.Pointer | interop.Reference<number>, reallocFunc: interop.Pointer | interop.Reference<number>, strdupFunc: interop.Pointer | interop.Reference<number>): number;
...
declare function xmlMemSetup(freeFunc: number, mallocFunc: number, reallocFunc: number, strdupFunc: number): number;
...
declare function xmlNewTextWriterTree(doc: interop.Pointer | interop.Reference<_xmlDoc>, node: number, compression: number): interop.Pointer | interop.Reference<any>;
...
declare function xmlXPathCastNodeToNumber(node: number): number;

declare function xmlXPathCastNodeToString(node: number): interop.Pointer | interop.Reference<number>;
...
declare function xmlXPathCmpNodes(node1: number, node2: number): number;
...
declare function xmlXPathNewNodeSet(val: number): interop.Pointer | interop.Reference<_xmlXPathObject>;
...
declare function xmlXPathNewValueTree(val: number): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPathNextAncestor(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextAncestorOrSelf(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextAttribute(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextChild(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextDescendant(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextDescendantOrSelf(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextFollowing(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextFollowingSibling(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextNamespace(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextParent(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextPreceding(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextPrecedingSibling(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNextSelf(ctxt: interop.Pointer | interop.Reference<_xmlXPathParserContext>, cur: number): number;

declare function xmlXPathNodeEval(node: number, str: interop.Pointer | interop.Reference<number>, ctx: interop.Pointer | interop.Reference<_xmlXPathContext>): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPathNodeLeading(nodes: interop.Pointer | interop.Reference<_xmlNodeSet>, node: number): interop.Pointer | interop.Reference<_xmlNodeSet>;

declare function xmlXPathNodeLeadingSorted(nodes: interop.Pointer | interop.Reference<_xmlNodeSet>, node: number): interop.Pointer | interop.Reference<_xmlNodeSet>;

declare function xmlXPathNodeSetAdd(cur: interop.Pointer | interop.Reference<_xmlNodeSet>, val: number): number;

declare function xmlXPathNodeSetAddNs(cur: interop.Pointer | interop.Reference<_xmlNodeSet>, node: number, ns: interop.Pointer | interop.Reference<_xmlNs>): number;

declare function xmlXPathNodeSetAddUnique(cur: interop.Pointer | interop.Reference<_xmlNodeSet>, val: number): number;

declare function xmlXPathNodeSetContains(cur: interop.Pointer | interop.Reference<_xmlNodeSet>, val: number): number;

declare function xmlXPathNodeSetCreate(val: number): interop.Pointer | interop.Reference<_xmlNodeSet>;

declare function xmlXPathNodeSetDel(cur: interop.Pointer | interop.Reference<_xmlNodeSet>, val: number): void;
...
declare function xmlXPathNodeTrailing(nodes: interop.Pointer | interop.Reference<_xmlNodeSet>, node: number): interop.Pointer | interop.Reference<_xmlNodeSet>;

declare function xmlXPathNodeTrailingSorted(nodes: interop.Pointer | interop.Reference<_xmlNodeSet>, node: number): interop.Pointer | interop.Reference<_xmlNodeSet>;
...
declare function xmlXPathSetContextNode(node: number, ctx: interop.Pointer | interop.Reference<_xmlXPathContext>): number;
...
declare function xmlXPtrBuildNodeList(obj: interop.Pointer | interop.Reference<_xmlXPathObject>): number;
...
declare function xmlXPtrNewCollapsedRange(start: number): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewContext(doc: interop.Pointer | interop.Reference<_xmlDoc>, here: number, origin: number): interop.Pointer | interop.Reference<_xmlXPathContext>;
...
declare function xmlXPtrNewLocationSetNodes(start: number, end: number): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewRange(start: number, startindex: number, end: number, endindex: number): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewRangeNodeObject(start: number, end: interop.Pointer | interop.Reference<_xmlXPathObject>): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewRangeNodePoint(start: number, end: interop.Pointer | interop.Reference<_xmlXPathObject>): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewRangeNodes(start: number, end: number): interop.Pointer | interop.Reference<_xmlXPathObject>;

declare function xmlXPtrNewRangePointNode(start: interop.Pointer | interop.Reference<_xmlXPathObject>, end: number): interop.Pointer | interop.Reference<_xmlXPathObject>;
